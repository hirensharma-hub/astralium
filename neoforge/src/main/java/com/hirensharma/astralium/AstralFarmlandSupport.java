...
public final class AstralFarmlandSupport {
    ...
    private static final TagKey<Block> VALID_FARMLAND = com.hirensharma.astralium.RuntimeMappings.tagKey(com.hirensharma.astralium.RuntimeMappings.registryKey("BLOCK", "f_256747_"), new ResourceLocation(AstraliumMod.MOD_ID, "valid_crop_farmland"));
