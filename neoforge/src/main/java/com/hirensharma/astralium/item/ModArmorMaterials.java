...
public enum ModArmorMaterials implements ArmorMaterial {
    ASTRALIUM(AstraliumMod.MOD_ID + ":astralium", 48, new int[]{4, 7, 9, 4}, 22, armorEquipNetherite(), 3.5F, 0.15F);
    ...
    private static SoundEvent armorEquipNetherite() {
        return (SoundEvent) com.hirensharma.astralium.RuntimeMappings.staticField(SoundEvents.class, "ARMOR_EQUIP_NETHERITE", "f_11679_");
    }
