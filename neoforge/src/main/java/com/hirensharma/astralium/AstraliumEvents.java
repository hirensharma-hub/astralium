...
public class AstraliumEvents {
    ...
    public void onPlayerTick(TickEvent.PlayerTickEvent event) {
        if (com.hirensharma.astralium.RuntimeMappings.level(event.player).isClientSide || !(event.player instanceof ServerPlayer player)) return;
        ...
        } else if (com.hirensharma.astralium.RuntimeMappings.onGround(player)) {
    ...
    public void onCriticalHit(CriticalHitEvent event) {
        if (!(event.getEntity() instanceof ServerPlayer player)
            ...
            || com.hirensharma.astralium.RuntimeMappings.onGround(player)
            || player.isSprinting()
    ...
    public void onBreakSpeed(PlayerEvent.BreakSpeed event) {
        ...
        ItemStack stack = RuntimeMappings.mainHandItem(player);
    ...
    public void onClone(PlayerEvent.Clone event) {
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            PickaxeAreaMiningHandler.clearPlayer(com.hirensharma.astralium.RuntimeMappings.uuid(player));
        }
    }
