...
public final class AstraliumClient {
    ...
    public static final class ClientForgeEvents {
        ...
        public static void onClientTick(TickEvent.ClientTickEvent event) {
            ...
            wasGrounded = com.hirensharma.astralium.RuntimeMappings.onGround(minecraft.player)
        ...
        private static void requestModeCycle(Minecraft minecraft) {
            if (minecraft.player != null) {
                ExcavationTool tool = ExcavationTool.from(RuntimeMappings.mainHandItem(minecraft.player));
                if (tool != null) {
        ...
        private static void requestDoubleJump(Minecraft minecraft) {
            if (!com.hirensharma.astralium.RuntimeMappings.onGround(minecraft.player)
        ...
        public static void onRenderHighlight(RenderHighlightEvent.Block event) {
            ...
            ItemStack stack = RuntimeMappings.mainHandItem(minecraft.player);
        ...
        public static void onRenderLevelStage(RenderLevelStageEvent event) {
            ...
            if (!(RuntimeMappings.mainHandItem(minecraft.player).getItem() instanceof BlockItem)) return;
