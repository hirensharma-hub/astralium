...
public class AstraliumPickaxeItem extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        MiningMode mode = level != null && level.isClientSide
            ...
            : getMode(stack);
        tooltip.add(Component.translatable("tooltip.astralium.pickaxe.flavor").withStyle(ChatFormatting.DARK_PURPLE));
        tooltip.add(Component.translatable("tooltip.astralium.pickaxe.mode", mode.displayName()).withStyle(ChatFormatting.AQUA));
        tooltip.add(Component.translatable("tooltip.astralium.pickaxe.cycle").withStyle(ChatFormatting.GRAY));
    }
}
