...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> ASTRALIUM_ORE = BLOCKS.register("astralium_ore", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(55.0F, 1200.0F).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
    public static final RegistryObject<Block> ASTRALIUM_BLOCK = BLOCKS.register("astralium_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(60.0F, 1200.0F).requiresCorrectToolForDrops().sound(SoundType.NETHERITE_BLOCK)));
    public static final RegistryObject<Block> RAW_ASTRALIUM_BLOCK = BLOCKS.register("raw_astralium_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_PURPLE).strength(50.0F, 1200.0F).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
